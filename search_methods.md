...
- **Screened runners discarded:** tryglen kept as documented fallback (7/7/7); osseus 7 with downscale caveat (full-res > cap; judged twice at `-Z 2200` file); caseyinsure 7+7 but lower ceiling than specific.
