...
- **Pool sweep (D56, TC wire):** airbound elected live **8/10** first-screen (non-binding screening per D55 lesson #1); keenable 6/10 (Framer); generalintuition 4/10; stability 5 (D55-era, squarespace — non-contemporaneous, backup only); gatik/inherent/letara skipped; navi 403 (unreachable); luffu no funding. All screening-time signals committed (`.tmp_tools/signals/d56_*.json`).
