...
````yaml /api-reference/openapi.json get /v1/email/{id}
openapi: 3.0.3
info:
  title: Naïve API
  version: 2.0.0
              ...
              schema:
                ...
                properties:
                  ...
                  body:
                    type: string
                    nullable: true
                    description: Plain-text body. Null when the message carried only HTML.
                  html:
                    type: string
                    nullable: true
                    description: HTML body. Null when the message carried only plain text.
                  message_id:
                    type: string
                    nullable: true
                  received_at:
