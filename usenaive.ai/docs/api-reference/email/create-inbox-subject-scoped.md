...
# Create inbox (subject-scoped)

> Alias of `POST /v1/users/{user_id}/email/inboxes`.



## OpenAPI

````yaml /api-reference/openapi.json post /v1/users/{user_id}/email/create-inbox
openapi: 3.0.3
info:
  title: Naïve API
  version: 2.0.0
...
tags:
  ...
  - name: Cron
    description: >-
      ...
      customers.
paths:
  /v1/users/{user_id}/email/create-inbox:
    post:
      tags:
        - Email
      summary: Create inbox (subject-scoped)
      description: Alias of `POST /v1/users/{user_id}/email/inboxes`.
      parameters:
