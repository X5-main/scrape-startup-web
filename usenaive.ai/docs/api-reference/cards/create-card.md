...
> Create a virtual card and a Stripe checkout for funding. Approval-gated.
  ...
  /v1/cards:
    post:
      tags:
        - Cards
      summary: Create card
      description: Create a virtual card and a Stripe checkout for funding. Approval-gated.
      requestBody:
        required: true
        content:
          application/json:
