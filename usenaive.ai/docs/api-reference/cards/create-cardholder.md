...
> Create a Stripe Issuing cardholder. Approval-gated.



## OpenAPI

````yaml /api-reference/openapi.json post /v1/cards/cardholder
openapi: 3.0.3
info:
  title: Naïve API
  version: 2.0.0
...
paths:
  /v1/cards/cardholder:
    post:
      ...
      description: Create a Stripe Issuing cardholder. Approval-gated.
      requestBody:
        required: true
        content:
          application/json:
