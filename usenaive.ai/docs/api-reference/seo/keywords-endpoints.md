...
> List the DataForSEO Keywords Data endpoints available.



## OpenAPI

````yaml /api-reference/openapi.json get /v1/seo/keywords/endpoints
openapi: 3.0.3
info:
  title: Naïve API
  version: 2.0.0
...
tags:
  ...
  - name: Cron
    description: >-
      ...
      customers.
paths:
  /v1/seo/keywords/endpoints:
    get:
      tags:
        - SEO
      summary: Keywords endpoints
      description: List the DataForSEO Keywords Data endpoints available.
      responses:
        '200':
          description: OK.
          content:
