...
> Labs metadata. `meta` is one of: locations-and-languages, categories, status.



## OpenAPI

````yaml /api-reference/openapi.json get /v1/seo/labs/{meta}
openapi: 3.0.3
info:
  title: Naïve API
  version: 2.0.0
...
paths:
  /v1/seo/labs/{meta}:
    get:
      tags:
        - SEO
      summary: Labs metadata
      description: >-
        Labs metadata. `meta` is one of: locations-and-languages, categories,
        status.
      parameters:
        - name: meta
          in: path
