...
> Live DataForSEO Backlinks query. `endpoint` is one of: summary, history, backlinks, anchors, domain-pages, domain-pages-summary, referring-domains, referring-networks, competitors, domain-intersection, page-intersection, timeseries-summary, timeseries-new-lost, bulk-backlinks, bulk-referring-domains, bulk-ranks, bulk-spam-score, bulk-new-lost, bulk-pages-summary, id-list.



## OpenAPI

````yaml /api-reference/openapi.json post /v1/seo/backlinks/{endpoint}
openapi: 3.0.3
info:
  title: Naïve API
  version: 2.0.0
...
tags:
  ...
  - name: Cron
    description: >-
      ...
      customers.
paths:
  /v1/seo/backlinks/{endpoint}:
    post:
      tags:
        - SEO
      summary: Backlinks (live)
      description: >-
        Live DataForSEO Backlinks query. `endpoint` is one of: summary, history,
        backlinks, anchors, domain-pages, domain-pages-summary,
        referring-domains, referring-networks, competitors, domain-intersection,
        page-intersection, timeseries-summary, timeseries-new-lost,
        bulk-backlinks, bulk-referring-domains, bulk-ranks, bulk-spam-score,
        bulk-new-lost, bulk-pages-summary, id-list.
      parameters:
        - name: endpoint
          in: path
          required: true
