...
# Keywords (tasks ready)



## OpenAPI

````yaml /api-reference/openapi.json get /v1/seo/keywords/{engine}/{endpoint}/tasks-ready
openapi: 3.0.3
info:
  title: Naïve API
  version: 2.0.0
...
tags:
  ...
  - name: Cron
    description: >-
      ...
      customers.
paths:
  /v1/seo/keywords/{engine}/{endpoint}/tasks-ready:
    get:
      tags:
        - SEO
      summary: Keywords (tasks ready)
      parameters:
        - name: engine
          in: path
          required: true
