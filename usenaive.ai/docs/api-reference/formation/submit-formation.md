...
> Submit a paid formation to Doola. Approval-gated.



## OpenAPI

````yaml /api-reference/openapi.json post /v1/formation/{id}/submit
openapi: 3.0.3
info:
  title: Naïve API
  version: 2.0.0
...
tags:
  ...
  - name: Cron
    description: >-
      ...
      customers.
paths:
  /v1/formation/{id}/submit:
    post:
      tags:
        - Formation
      summary: Submit formation
      description: Submit a paid formation to Doola. Approval-gated.
      parameters:
        - name: id
          in: path
          required: true
