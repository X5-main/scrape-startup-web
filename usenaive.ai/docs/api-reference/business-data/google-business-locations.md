...
> Lists supported locations for Google business-data endpoints.



## OpenAPI

````yaml /api-reference/openapi.json get /v1/business/google/locations
openapi: 3.0.3
info:
  title: Naïve API
  version: 2.0.0
...
tags:
  ...
  - name: Cron
    description: >-
      ...
      customers.
paths:
  /v1/business/google/locations:
    get:
      tags:
        - Business Data
      summary: Google business locations
      description: Lists supported locations for Google business-data endpoints.
      responses:
        '200':
          description: OK.
          content:
