...
> Lists supported languages for Tripadvisor business-data endpoints.



## OpenAPI

````yaml /api-reference/openapi.json get /v1/business/tripadvisor/languages
openapi: 3.0.3
info:
  title: Naïve API
  version: 2.0.0
...
tags:
  ...
  - name: Cron
    description: >-
      ...
      customers.
paths:
  /v1/business/tripadvisor/languages:
    get:
      tags:
        - Business Data
      summary: Tripadvisor languages
      description: Lists supported languages for Tripadvisor business-data endpoints.
      responses:
        '200':
          description: OK.
          content:
