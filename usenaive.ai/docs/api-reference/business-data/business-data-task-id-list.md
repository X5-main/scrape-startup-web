...
# Business data (task id list)

> Lists previously submitted Business Data task IDs.



## OpenAPI

````yaml /api-reference/openapi.json post /v1/business/id-list
openapi: 3.0.3
info:
  title: Naïve API
  version: 2.0.0
...
paths:
  /v1/business/id-list:
    post:
      tags:
        - Business Data
      summary: Business data (task id list)
      description: Lists previously submitted Business Data task IDs.
      requestBody:
        required: true
        content:
          application/json:
