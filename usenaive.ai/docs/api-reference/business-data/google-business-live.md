...
> Live Google business-data query. `endpoint`: my-business-info, hotel-searches, hotel-info, questions-and-answers.



## OpenAPI

````yaml /api-reference/openapi.json post /v1/business/google/{endpoint}
openapi: 3.0.3
info:
  title: Naïve API
  version: 2.0.0
...
tags:
  ...
  - name: Cron
    description: >-
      ...
      customers.
paths:
  /v1/business/google/{endpoint}:
    post:
      tags:
        - Business Data
      summary: Google business (live)
      description: >-
        Live Google business-data query. `endpoint`: my-business-info,
        hotel-searches, hotel-info, questions-and-answers.
      parameters:
        - name: endpoint
          in: path
          required: true
