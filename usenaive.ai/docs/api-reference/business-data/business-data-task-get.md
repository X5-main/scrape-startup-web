...
# Business data (task get)



## OpenAPI

````yaml /api-reference/openapi.json get /v1/business/{platform}/{endpoint}/task/{id}
openapi: 3.0.3
info:
  title: Naïve API
  version: 2.0.0
...
tags:
  ...
  - name: Cron
    description: >-
      ...
      customers.
paths:
  /v1/business/{platform}/{endpoint}/task/{id}:
    get:
      tags:
        - Business Data
      summary: Business data (task get)
      parameters:
        - name: platform
          in: path
          required: true
