...
> Lists supported languages for Google business-data endpoints.



## OpenAPI

````yaml /api-reference/openapi.json get /v1/business/google/languages
openapi: 3.0.3
info:
  title: Naïve API
  version: 2.0.0
...
tags:
  ...
  - name: Cron
    description: >-
      ...
      customers.
paths:
  /v1/business/google/languages:
    get:
      tags:
        - Business Data
      summary: Google business languages
      description: Lists supported languages for Google business-data endpoints.
      responses:
        '200':
          description: OK.
          content:
