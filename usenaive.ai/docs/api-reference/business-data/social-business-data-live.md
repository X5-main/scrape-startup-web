...
# Social business data (live)

> Live social media business-data query. `platform`: facebook, pinterest, reddit.



## OpenAPI

````yaml /api-reference/openapi.json post /v1/business/social/{platform}
openapi: 3.0.3
info:
  title: Naïve API
  version: 2.0.0
...
tags:
  ...
  - name: Cron
    description: >-
      ...
      customers.
paths:
  /v1/business/social/{platform}:
    post:
      tags:
        - Business Data
      summary: Social business data (live)
      description: >-
        Live social media business-data query. `platform`: facebook, pinterest,
        reddit.
      parameters:
        - name: platform
          in: path
