...
> 501: there is no `policy_decisions` table in this build.



## OpenAPI

````yaml /api-reference/openapi.json get /v1/policy/decisions
openapi: 3.0.3
info:
  title: Naïve API
  version: 2.0.0
...
paths:
  /v1/policy/decisions:
    get:
      ...
      description: '501: there is no `policy_decisions` table in this build.'
      parameters:
        - name: cursor
          in: query
          required: false
