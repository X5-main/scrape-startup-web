...
# Which declared claims an attester covers



## OpenAPI

````yaml /api-reference/openapi.json get /v1/attestation-parity
openapi: 3.0.3
info:
  title: Naïve API
  version: 2.0.0
...
tags:
  ...
  - name: Cron
    description: >-
      ...
      customers.
paths:
  /v1/attestation-parity:
    get:
      tags:
        - Governance
      summary: Which declared claims an attester covers
      responses:
        '401':
