...
# The per-toolkit tool filter policy enforces



## OpenAPI

````yaml /api-reference/openapi.json get /v1/connections/toolkits/{toolkit}/tools
openapi: 3.0.3
info:
  title: Naïve API
  version: 2.0.0
...
tags:
  ...
  - name: Cron
    description: >-
      ...
      customers.
paths:
  /v1/connections/toolkits/{toolkit}/tools:
    get:
      tags:
        - Governance
      summary: The per-toolkit tool filter policy enforces
      parameters:
        - name: toolkit
          in: path
          required: true
