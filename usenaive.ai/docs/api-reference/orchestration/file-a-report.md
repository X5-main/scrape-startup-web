...
> Send a bug or feedback report from the CLI; forwarded to the internal reporting service.



## OpenAPI

````yaml /api-reference/openapi.json post /v1/reports
openapi: 3.0.3
info:
  title: Naïve API
  version: 2.0.0
...
paths:
  /v1/reports:
    post:
      ...
      description: >-
        Send a bug or feedback report from the CLI; forwarded to the internal
        reporting service.
      requestBody:
        required: true
        content:
