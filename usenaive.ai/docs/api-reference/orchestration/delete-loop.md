...
> Delete the Loop binding. The backing Hermes cron job, if any, is deleted best-effort.



## OpenAPI

````yaml /api-reference/openapi.json delete /v1/loops/{id}
openapi: 3.0.3
info:
  title: Naïve API
  version: 2.0.0
...
paths:
  /v1/loops/{id}:
    delete:
      ...
      summary: Delete loop
      description: >-
        Delete the Loop binding. The backing Hermes cron job, if any, is deleted
        best-effort.
      parameters:
        - name: id
          in: path
