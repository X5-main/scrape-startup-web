...
> Transitions the run to a terminal status exactly once (compare-and-set on ended_at); a repeat call is idempotent and returns the run as the winner left it. An optional debrief is consolidated into the brain best-effort.



## OpenAPI

````yaml /api-reference/openapi.json post /v1/runs/{id}/complete
openapi: 3.0.3
info:
  title: Naïve API
  version: 2.0.0
...
paths:
  /v1/runs/{id}/complete:
    post:
      ...
      description: >-
        Transitions the run to a terminal status exactly once (compare-and-set
        on ended_at); a repeat call is idempotent and returns the run as the
        winner left it. An optional debrief is consolidated into the brain
        best-effort.
      parameters:
        - name: id
          in: path
          ...
          application/json:
            schema:
              ...
              properties:
                ...
                debrief:
                  type: object
                  description: Run-end learnings flowed back into memory automatically.
                  properties:
                    learned:
                      type: array
                      maxItems: 100
                    ...
                    contradicts:
                      ...
                      items:
                        type: string
                        maxLength: 64
                      description: Capsule belief labels (B1..Bn) this run contradicts.
                    citations:
                      type: object
              ...
              schema:
                ...
                properties:
                  ...
                  consolidation:
                    ...
                    nullable: true
                    description: >-
                      Present only when a debrief was supplied and consolidation
                      succeeded; null otherwise (consolidation failure is
                      non-fatal).
                    properties:
                      envelope_id:
                        type: string
