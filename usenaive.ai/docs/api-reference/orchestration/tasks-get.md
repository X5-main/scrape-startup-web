...
> GET /v1/tasks/:id — Get full task details including runs, events, and comments.
...
| ----- | ------ | --------------------------------------------------------------------- |
| `id`  | string | Task ID — accepts both UUIDs and Hermes task IDs (e.g., `t_a2a1ae0c`) |
...
| `runs`     | array  | Worker run history for this task |
| `events`   | array  | Status change events             |
| `comments` | array  | Activity comments                |
