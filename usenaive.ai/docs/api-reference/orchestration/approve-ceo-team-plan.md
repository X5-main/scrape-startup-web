...
> Approve a CEO-proposed team plan — creates agents, provisions them, and optionally creates apps and phase-1 tasks.



## OpenAPI

````yaml /api-reference/openapi.json post /v1/companies/{id}/ceo/team/approve
openapi: 3.0.3
info:
  title: Naïve API
  version: 2.0.0
...
tags:
  ...
  - name: Cron
    description: >-
      ...
      customers.
paths:
  /v1/companies/{id}/ceo/team/approve:
    post:
      tags:
        - Orchestration
      summary: Approve CEO team plan
      description: >-
        Approve a CEO-proposed team plan — creates agents, provisions them, and
        optionally creates apps and phase-1 tasks.
      parameters:
        - name: id
          in: path
          required: true
