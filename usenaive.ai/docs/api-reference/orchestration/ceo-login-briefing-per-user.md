...
# CEO login briefing (per-user)

> Same as `GET /v1/companies/{id}/ceo/briefing`, scoped through the tenant user route.



## OpenAPI

````yaml /api-reference/openapi.json get /v1/users/{user_id}/ceo/briefing
openapi: 3.0.3
info:
  title: Naïve API
  version: 2.0.0
...
tags:
  ...
  - name: Cron
    description: >-
      ...
      customers.
paths:
  /v1/users/{user_id}/ceo/briefing:
    get:
      tags:
        - Orchestration
      summary: CEO login briefing (per-user)
      description: >-
        Same as `GET /v1/companies/{id}/ceo/briefing`, scoped through the tenant
        user route.
      parameters:
