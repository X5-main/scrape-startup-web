...
> Activity since last login for a CEO briefing summary.



## OpenAPI

````yaml /api-reference/openapi.json get /v1/companies/{id}/ceo/briefing
openapi: 3.0.3
info:
  title: Naïve API
  version: 2.0.0
...
tags:
  ...
  - name: Cron
    description: >-
      ...
      customers.
paths:
  /v1/companies/{id}/ceo/briefing:
    get:
      tags:
        - Orchestration
      summary: CEO login briefing
      description: Activity since last login for a CEO briefing summary.
      parameters:
        - name: id
          in: path
          required: true
