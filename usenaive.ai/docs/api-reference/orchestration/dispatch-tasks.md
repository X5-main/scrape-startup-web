...
> Push-through to the sidecar kanban dispatcher.



## OpenAPI

````yaml /api-reference/openapi.json post /v1/tasks/dispatch
openapi: 3.0.3
info:
  title: Naïve API
  version: 2.0.0
...
paths:
  /v1/tasks/dispatch:
    post:
      ...
      description: Push-through to the sidecar kanban dispatcher.
      responses:
        '200':
