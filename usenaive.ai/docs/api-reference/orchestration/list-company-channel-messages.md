...
# List company channel messages



## OpenAPI

````yaml /api-reference/openapi.json get /v1/company-channel/messages
openapi: 3.0.3
info:
  title: Naïve API
  version: 2.0.0
...
paths:
  /v1/company-channel/messages:
    get:
      tags:
        - Orchestration
      summary: List company channel messages
      parameters:
        - name: limit
          in: query
          required: false
          description: Max messages (1-200, default 100).
          schema:
            type: integer
            default: 100
            minimum: 1
