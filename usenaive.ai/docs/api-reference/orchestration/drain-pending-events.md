...
> Internal sweep that dispatches pending events into runs and tasks; gated by the `x-cron-secret` shared secret.



## OpenAPI

````yaml /api-reference/openapi.json post /v1/cron/drain-events
openapi: 3.0.3
info:
  title: Naïve API
  version: 2.0.0
...
tags:
  ...
  - name: Cron
    description: >-
      ...
      customers.
paths:
  /v1/cron/drain-events:
    post:
      tags:
        - Orchestration
      summary: Drain pending events
      description: >-
        Internal sweep that dispatches pending events into runs and tasks; gated
        by the `x-cron-secret` shared secret.
      parameters:
        - name: limit
          in: query
          required: false
          schema:
            ...
            default: 20
            maximum: 200
          description: Max events to drain.
      responses:
        '200':
