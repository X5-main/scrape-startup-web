...
> Posts a message; @mentions by a human session dispatch the mentioned agents.



## OpenAPI

````yaml /api-reference/openapi.json post /v1/company-channel/messages
openapi: 3.0.3
info:
  title: Naïve API
  version: 2.0.0
...
tags:
  ...
  - name: Cron
    description: >-
      ...
      customers.
paths:
  /v1/company-channel/messages:
    post:
      tags:
        - Orchestration
      summary: Post a company channel message
      description: >-
        Posts a message; @mentions by a human session dispatch the mentioned
        agents.
      parameters:
          ...
          application/json:
            schema:
              ...
              properties:
                ...
                author_type:
                  type: string
                  description: Defaults to owner on session auth, agent on key auth.
                author_id:
                  type: string
                author_name:
                  type: string
                mentions:
                  ...
                  items:
                    type: string
                  description: Overrides @names parsed from the message.
                metadata:
                  type: object
