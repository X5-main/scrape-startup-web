...
> Server-Sent Events proxy of the CEO run output.



## OpenAPI

````yaml /api-reference/openapi.json get /v1/companies/{id}/ceo/runs/{runId}/stream
openapi: 3.0.3
info:
  title: Naïve API
  version: 2.0.0
...
tags:
  ...
  - name: Cron
    description: >-
      ...
      customers.
paths:
  /v1/companies/{id}/ceo/runs/{runId}/stream:
    get:
      tags:
        - Orchestration
      summary: Stream CEO run (SSE)
      description: Server-Sent Events proxy of the CEO run output.
      parameters:
        - name: id
          in: path
          required: true
