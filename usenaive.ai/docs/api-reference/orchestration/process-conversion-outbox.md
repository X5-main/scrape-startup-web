...
# Process conversion outbox

> Internal sweep that ships queued conversion events to ad platforms; gated by the `x-cron-secret` shared secret.



## OpenAPI

````yaml /api-reference/openapi.json post /v1/cron/process-conversions
openapi: 3.0.3
info:
  title: Naïve API
  version: 2.0.0
...
tags:
  ...
  - name: Cron
    description: >-
      ...
      customers.
paths:
  /v1/cron/process-conversions:
    post:
      tags:
        - Orchestration
      summary: Process conversion outbox
      description: >-
        Internal sweep that ships queued conversion events to ad platforms;
        gated by the `x-cron-secret` shared secret.
      parameters:
        - name: limit
          in: query
          required: false
          schema:
            ...
            default: 50
            maximum: 500
          description: Max outbox rows to process.
      responses:
        '200':
