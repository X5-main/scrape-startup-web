...
> Download raw file bytes from the container workspace.



## OpenAPI

````yaml /api-reference/openapi.json get /v1/companies/{id}/files/download
openapi: 3.0.3
info:
  title: Naïve API
  version: 2.0.0
...
tags:
  ...
  - name: Cron
    description: >-
      ...
      customers.
paths:
  /v1/companies/{id}/files/download:
    get:
      tags:
        - Files
      summary: Download file
      description: Download raw file bytes from the container workspace.
      parameters:
        - name: id
          in: path
          required: true
