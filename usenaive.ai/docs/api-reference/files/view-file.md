...
````yaml /api-reference/openapi.json post /v1/companies/{id}/files/view
openapi: 3.0.3
info:
  title: Naïve API
  version: 2.0.0
...
tags:
  ...
  - name: Cron
    description: >-
      ...
      customers.
paths:
  /v1/companies/{id}/files/view:
    post:
      tags:
        - Files
      summary: View file
      description: Read text file contents from the container workspace (max 1MB).
      parameters:
        - name: id
          in: path
          required: true
