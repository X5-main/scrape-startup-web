...
> Fetch and extract page content from a URL, optionally using LLM extraction. Costs 0.05 credits.



## OpenAPI

````yaml /api-reference/openapi.json post /v1/search/url
openapi: 3.0.3
info:
  title: Naïve API
  version: 2.0.0
...
paths:
  /v1/search/url:
    post:
      ...
      summary: Read URL
      description: >-
        Fetch and extract page content from a URL, optionally using LLM
        extraction. Costs 0.05 credits.
      requestBody:
        required: true
        content:
          application/json:
