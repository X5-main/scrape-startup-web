...
> Delete the session and clear the session cookie.



## OpenAPI

````yaml /api-reference/openapi.json post /v1/auth/session/logout
openapi: 3.0.3
info:
  title: Naïve API
  version: 2.0.0
  ...
  /v1/auth/session/logout:
    post:
      tags:
        - Auth & Onboarding
      summary: Logout
      description: Delete the session and clear the session cookie.
      responses:
        '200':
