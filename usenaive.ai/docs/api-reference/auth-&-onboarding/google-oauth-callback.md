...
> Handle the Google OAuth callback and redirect to the app with a one-time exchange code.



## OpenAPI

````yaml /api-reference/openapi.json get /v1/auth/oauth/google/callback
openapi: 3.0.3
info:
  title: Naïve API
  version: 2.0.0
...
paths:
  /v1/auth/oauth/google/callback:
    get:
      ...
      description: >-
        Handle the Google OAuth callback and redirect to the app with a one-time
        exchange code.
      parameters:
        - name: code
          in: query
      ...
      responses:
        '302':
          description: Redirect to the app callback URL.
      security: []
components:
  securitySchemes:
    bearerAuth:
