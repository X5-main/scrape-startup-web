...
> List companies accessible to the authenticated agent.



## OpenAPI

````yaml /api-reference/openapi.json get /v1/auth/companies
openapi: 3.0.3
info:
  title: Naïve API
  version: 2.0.0
...
paths:
  /v1/auth/companies:
    get:
      ...
      description: List companies accessible to the authenticated agent.
      responses:
        '200':
          description: OK.
          content:
