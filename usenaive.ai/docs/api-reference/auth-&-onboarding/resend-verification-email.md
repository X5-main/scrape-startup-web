...
````yaml /api-reference/openapi.json post /v1/auth/session/resend-verification
openapi: 3.0.3
info:
  title: Naïve API
  version: 2.0.0
...
tags:
  ...
  - name: Cron
    description: >-
      ...
      customers.
paths:
  /v1/auth/session/resend-verification:
    post:
      tags:
        - Auth & Onboarding
      summary: Resend verification email
      description: Resend the verification email link to the session user.
      requestBody:
        content:
          application/json:
            schema:
