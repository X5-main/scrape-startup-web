...
> Exchange a reset token for a new password. The token is single-use and expires.



## OpenAPI

````yaml /api-reference/openapi.json post /v1/auth/password/reset
openapi: 3.0.3
info:
  title: Naïve API
  version: 2.0.0
...
paths:
  /v1/auth/password/reset:
    post:
      ...
      description: >-
        Exchange a reset token for a new password. The token is single-use and
        expires.
      requestBody:
        required: true
        content:
