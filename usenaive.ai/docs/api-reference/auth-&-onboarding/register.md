...
````yaml /api-reference/openapi.json post /v1/auth/register
openapi: 3.0.3
info:
  title: Naïve API
  version: 2.0.0
  ...
  /v1/auth/register:
    post:
      tags:
        - Auth & Onboarding
      summary: Register
      description: Create a new user, company, agent, trial credits, and a default API key.
      requestBody:
        required: true
        content:
          application/json:
            schema:
              ...
              properties:
                ...
                company_name:
                  type: string
                  description: Defaults to "{name}'s Company".
      responses:
        '201':
          description: Created.
          content:
