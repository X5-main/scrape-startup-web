...
> Change the password for the session user's credential account.



## OpenAPI

````yaml /api-reference/openapi.json post /v1/auth/change-password
openapi: 3.0.3
info:
  title: Naïve API
  version: 2.0.0
...
paths:
  /v1/auth/change-password:
    post:
      ...
      description: Change the password for the session user's credential account.
      requestBody:
        required: true
        content:
          application/json:
