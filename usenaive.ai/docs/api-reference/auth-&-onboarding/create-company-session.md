...
> Create a new company for the session user, optionally applying a business template.



## OpenAPI

````yaml /api-reference/openapi.json post /v1/auth/session/create-company
openapi: 3.0.3
info:
  title: Naïve API
  version: 2.0.0
...
tags:
  ...
  - name: Cron
    description: >-
      ...
      customers.
paths:
  /v1/auth/session/create-company:
    post:
      tags:
        - Auth & Onboarding
      summary: Create company (session)
      description: >-
        Create a new company for the session user, optionally applying a
        business template.
      requestBody:
        required: true
        content:
