...
# Messages in one team session



## OpenAPI

````yaml /api-reference/openapi.json get /v1/teams/{team}/tenants/{tenantUserId}/sessions/{channel}
openapi: 3.0.3
info:
  title: Naïve API
  version: 2.0.0
...
tags:
  ...
  - name: Cron
    description: >-
      ...
      customers.
paths:
  /v1/teams/{team}/tenants/{tenantUserId}/sessions/{channel}:
    get:
      tags:
        - Runtime
      summary: Messages in one team session
      parameters:
        - name: team
          in: path
          required: true
