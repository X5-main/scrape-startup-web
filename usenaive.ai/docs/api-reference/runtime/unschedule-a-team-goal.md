...
# Unschedule a team goal



## OpenAPI

````yaml /api-reference/openapi.json delete /v1/teams/{team}/tenants/{tenantUserId}/schedule/{id}
openapi: 3.0.3
info:
  title: Naïve API
  version: 2.0.0
...
tags:
  ...
  - name: Cron
    description: >-
      ...
      customers.
paths:
  /v1/teams/{team}/tenants/{tenantUserId}/schedule/{id}:
    delete:
      tags:
        - Runtime
      summary: Unschedule a team goal
      parameters:
        - name: team
          in: path
          required: true
