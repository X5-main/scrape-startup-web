...
````yaml /api-reference/openapi.json get /v1/teams/{team}/tenants/{tenantUserId}/events
openapi: 3.0.3
info:
  title: Naïve API
  version: 2.0.0
...
tags:
  ...
  - name: Cron
    description: >-
      ...
      customers.
paths:
  /v1/teams/{team}/tenants/{tenantUserId}/events:
    get:
      tags:
        - Runtime
      summary: Frames for a tenant, optionally one card
      parameters:
        - name: team
          in: path
          required: true
        ...
        - name: task
          ...
          schema:
            type: string
          description: Filter to one board id.
        - name: cursor
          in: query
          required: false
          schema:
