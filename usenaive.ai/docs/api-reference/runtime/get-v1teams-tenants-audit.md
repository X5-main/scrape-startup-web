...
# GET /v1/teams/{param1}/tenants/{param2}/audit
...
````yaml /api-reference/openapi.json get /v1/teams/{param1}/tenants/{param2}/audit
openapi: 3.0.3
info:
  title: Naïve API
  version: 2.0.0
...
tags:
  ...
  - name: Cron
    description: >-
      ...
      customers.
paths:
  /v1/teams/{param1}/tenants/{param2}/audit:
    get:
      tags:
        - Runtime
      summary: GET /v1/teams/{param1}/tenants/{param2}/audit
      description: >-
