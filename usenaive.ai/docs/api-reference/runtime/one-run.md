...
````yaml /api-reference/openapi.json get /v1/teams/{team}/tenants/{tenantUserId}/runs/{id}
openapi: 3.0.3
info:
  title: Naïve API
  version: 2.0.0
...
tags:
  ...
  - name: Cron
    description: >-
      ...
      customers.
paths:
  /v1/teams/{team}/tenants/{tenantUserId}/runs/{id}:
    get:
      tags:
        - Runtime
      summary: One run
      ...
      responses:
        '200':
          description: The run, with `events_url` and `stream_url`.
          content:
            application/json:
              schema:
                type: object
