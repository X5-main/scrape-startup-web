...
# Pending approvals for a team's tenant

> REAL. The approvals table is keyed on (company, tenant_user), which is exactly this address.



## OpenAPI

````yaml /api-reference/openapi.json get /v1/teams/{team}/tenants/{tenantUserId}/approvals
openapi: 3.0.3
info:
  title: Naïve API
  version: 2.0.0
...
tags:
  ...
  - name: Cron
    description: >-
      ...
      customers.
paths:
  /v1/teams/{team}/tenants/{tenantUserId}/approvals:
    get:
      tags:
        - Runtime
      summary: Pending approvals for a team's tenant
      description: >-
        REAL. The approvals table is keyed on (company, tenant_user), which is
