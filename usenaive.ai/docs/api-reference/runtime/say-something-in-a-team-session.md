...
# Say something in a team session



## OpenAPI

````yaml /api-reference/openapi.json post /v1/teams/{team}/tenants/{tenantUserId}/sessions/{channel}/messages
openapi: 3.0.3
info:
  title: Naïve API
  version: 2.0.0
...
tags:
  ...
  - name: Cron
    description: >-
      ...
      customers.
paths:
  /v1/teams/{team}/tenants/{tenantUserId}/sessions/{channel}/messages:
    post:
      tags:
        - Runtime
      summary: Say something in a team session
      parameters:
        - name: team
          in: path
          required: true
