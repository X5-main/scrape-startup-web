...
# Change a team's model



## OpenAPI

````yaml /api-reference/openapi.json post /v1/teams/{team}/tenants/{tenantUserId}/model
openapi: 3.0.3
info:
  title: Naïve API
  version: 2.0.0
...
tags:
  ...
  - name: Cron
    description: >-
      ...
      customers.
paths:
  /v1/teams/{team}/tenants/{tenantUserId}/model:
    post:
      tags:
        - Runtime
      summary: Change a team's model
      parameters:
        - name: team
          in: path
          required: true
