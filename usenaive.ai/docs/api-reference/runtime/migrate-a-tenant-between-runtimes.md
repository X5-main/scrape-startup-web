...
# Migrate a tenant between runtimes



## OpenAPI

````yaml /api-reference/openapi.json post /v1/teams/{team}/tenants/{tenantUserId}/migrate
openapi: 3.0.3
info:
  title: Naïve API
  version: 2.0.0
...
tags:
  ...
  - name: Cron
    description: >-
      ...
      customers.
paths:
  /v1/teams/{team}/tenants/{tenantUserId}/migrate:
    post:
      tags:
        - Runtime
      summary: Migrate a tenant between runtimes
      parameters:
        - name: team
          in: path
          required: true
