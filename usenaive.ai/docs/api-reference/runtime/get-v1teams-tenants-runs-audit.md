...
# GET /v1/teams/{param1}/tenants/{param2}/runs/{param3}/audit

> Stub added to close spec-drift; see the hand-written api-reference page for this primitive for full request/response details.



## OpenAPI

````yaml /api-reference/openapi.json get /v1/teams/{param1}/tenants/{param2}/runs/{param3}/audit
openapi: 3.0.3
info:
  title: Naïve API
  version: 2.0.0
...
tags:
  ...
  - name: Cron
    description: >-
      ...
      customers.
paths:
  /v1/teams/{param1}/tenants/{param2}/runs/{param3}/audit:
    get:
      tags:
        - Runtime
      summary: GET /v1/teams/{param1}/tenants/{param2}/runs/{param3}/audit
      description: >-
        Stub added to close spec-drift; see the hand-written api-reference page
        for this primitive for full request/response details.
      parameters:
        - name: param1
          in: path
          required: true
      ...
      responses:
        '200':
          description: OK
        '202':
          description: Accepted (deferred for human approval when gated)
components:
  securitySchemes:
    bearerAuth:
      type: http
