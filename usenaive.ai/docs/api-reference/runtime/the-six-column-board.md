...
````yaml /api-reference/openapi.json get /v1/teams/{team}/tenants/{tenantUserId}/board
openapi: 3.0.3
info:
  title: Naïve API
  version: 2.0.0
...
tags:
  ...
  - name: Cron
    description: >-
      ...
      customers.
paths:
  /v1/teams/{team}/tenants/{tenantUserId}/board:
    get:
      tags:
        - Runtime
      summary: The six-column board
      parameters:
        - name: team
          in: path
          required: true
        ...
        - name: status
          ...
          schema:
            type: string
          description: One of open, claimed, awaiting_check, done, unverified, blocked.
        - name: role
          in: query
          required: false
          schema:
            type: string
          description: Filter to one assigned role.
        - name: cursor
          in: query
          required: false
          schema:
            type: string
          description: >-
            Opaque keyset cursor from the previous response's `next_cursor`.
            Never an offset.
        - name: limit
          in: query
          required: false
      ...
      responses:
        '200':
          description: Board cards, newest first.
          content:
            application/json:
              schema:
                type: object
                  ...
                  items:
                    ...
                    items:
                      ...
                      properties:
                        task_id:
                          type: string
                          description: The board id the runtime addresses this card by.
                        row_id:
                          type: string
                          description: >-
                            The naive UUID for the same card. Reported beside
                            the board id, never instead of it.
                        title:
                          type: string
                        status:
                          type: string
                          enum:
                            ...
                            - blocked
                          description: >-
                            The six board columns. Computed from
                            `tasks_mirror.status` AND `verification_status`
                            until R-6's CHECK makes their disagreement
                            unrepresentable.
                        role:
                          type: string
                          nullable: true
                          description: >-
                            The role that holds this card. Sourced from
                            `tasks_mirror.assignee`, which keeps its column
                            name.
                        attempts:
                          type: integer
                        lease:
                          ...
                          properties:
                            role:
                              type: string
                              description: >-
                                The role holding the lease — the same value as
                                the card's `role`.
                            expires_at:
                              type: string
                              format: date-time
                        ...
                        rubric:
                          ...
                          nullable: true
                          description: >-
                            Always null in this build: there is no per-card
                            check list. Null, not `{passed:0,total:0}` — which
                            would read as `no checks passed`.
                        ...
                        unverified_because:
                          ...
                          nullable: true
                          description: >-
                            REQUIRED whenever `status` is `unverified`. A
                            terminal state a user cannot explain is a broken
                            product.
                  next_cursor:
                    type: string
                    nullable: true
