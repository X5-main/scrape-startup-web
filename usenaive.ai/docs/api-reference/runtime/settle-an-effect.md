...
````yaml /api-reference/openapi.json post /v1/teams/{team}/tenants/{tenantUserId}/effects/{id}/settle
openapi: 3.0.3
info:
  title: Naïve API
  version: 2.0.0
...
tags:
  ...
  - name: Cron
    description: >-
      ...
      customers.
paths:
  /v1/teams/{team}/tenants/{tenantUserId}/effects/{id}/settle:
    post:
      tags:
        - Runtime
      summary: Settle an effect
      parameters:
        - name: team
          in: path
          required: true
