...
> Server-Sent Events stream of company-scoped live events (DNS edits, activity log, approvals). Heartbeat every ~25s.
...
paths:
  /v1/events:
    get:
      ...
      description: >-
        Server-Sent Events stream of company-scoped live events (DNS edits,
        activity log, approvals). Heartbeat every ~25s.
      responses:
        '200':
