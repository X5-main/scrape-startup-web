#!/usr/bin/env python3
"""Visible-text byte parity: live corma.ai vs 127.0.0.1:8919 replica (4 sitemap pages)."""
...
paths = ["/", "/defensive-gap-research/", "/introducing-corma/", "/privacy-policy/"]
for p in paths:
    live = get("https://corma.ai" + p)
    rep = get("http://127.0.0.1:8919" + p)
