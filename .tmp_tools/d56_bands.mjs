// D56: full-page capture via relay 9224 in VIEWPORT BANDS (page-coordinate
// clips) — the full-surface single-shot RPC times out on tall pages through
// the relay. Writes <outdir>/band_<NNN>.png + stitches nothing itself.
// Usage: bun d56_bands.mjs <url> <outdir>
const [, , url, outdir] = process.argv;
if (!url || !outdir) { console.error("usage: d56_bands.mjs <url> <outdir>"); process.exit(1); }
